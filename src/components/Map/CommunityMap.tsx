...
const MARKER_COLORS = {
  [CONFIG.REPORT_TYPES.ICE_CHECKPOINT]: '#ff6b35', // Orange - Checkpoints
  [CONFIG.REPORT_TYPES.ICE_RAID]: '#f44336',       // Red - Raids (highest priority)
  [CONFIG.REPORT_TYPES.ICE_PATROL]: '#ff9800',     // Amber - Patrols
  [CONFIG.REPORT_TYPES.ICE_DETENTION]: '#d32f2f',  // Dark Red - Detentions
  [CONFIG.REPORT_TYPES.COMMUNITY_SUPPORT]: '#4caf50' // Green - Community Support
};
